...
@property (strong, nonatomic) SampleViewController *sampleViewController;
...
{
  [self commonSetupWithOptions:launchOptions];
  return YES;
}

- (void)commonSetupWithOptions:(NSDictionary *)launchOptions {
